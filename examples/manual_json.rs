...
fn main() {
    ...
    fn match_fn(
        a: &Segment<SegmentKey, AlignedSequence<u8>>,
        b: &Segment<SegmentKey, AlignedSequence<u8>>,
    ) -> SequenceMatch<Segment<SegmentKey, AlignedSequence<u8>>> {
    ...
    fn score_fn(s: &Segment<SegmentKey, AlignedSequence<u8>>) -> Option<usize> {
